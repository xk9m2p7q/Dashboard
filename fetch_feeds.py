...
def fetch_exchange_rates():
    try:
        # Primary: Frankfurter (EUR, GBP) + open.er-api (MAD)
        # Frankfurter doesn't support MAD so we always use open.er-api for all rates
        ...
        with urllib.request.urlopen(req, timeout=15) as r:
            ...
            result = {
                ...
                "MAD": round(float(mad), 2) if mad else None,
                "date": date
            }
