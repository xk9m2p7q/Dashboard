...
with open("feeds.json", "w", encoding="utf-8") as f:
    json.dump({"updated": datetime.now(timezone.utc).isoformat(), "articles": articles}, f, ensure_ascii=False, indent=2)

print(f"Saved {len(articles)} articles to feeds.json")
